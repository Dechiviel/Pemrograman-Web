  ...
  <form action="no1.php" method="post">
    <div class="container">
      <div>
        ...
        Nrp<br><br>
        Nilai angka<br><br>
        <?php if (isset($_POST["submit"])) echo "Nilai huruf <br><br>";?>
        <?php if (isset($_POST["submit"])) echo "Predikat <br><br>";?>
        <input class="input" type="submit" name="submit" value="Submit">
      </div>
      <div>
        <input class="input" type="text" name="nama" required>
        <?php if (isset($_POST["submit"])) echo $_POST["nama"];?><br><br>

        <input class="input" type="number" name="nrp" required>
        <?php if (isset($_POST["submit"])) echo $_POST["nrp"];?><br><br>

        <input class="input" type="number" name="nilaiAngka" required>
        <?php if (isset($_POST["submit"])) echo $_POST["nilaiAngka"];?><br><br>
        ...
        <?php if (isset($_POST["submit"])) echo "$nilaiHuruf <br><br>";?>
