...
<body>
    ...
    <div class="row g-1">
      ...
      <div class="col-sm-3 col-lg-2 navi pe-0 ps-lg-1">
        ...
        <div class="menu-container1 mb-5">
          <div class="books ps-3 ps-lg-3 mt-1 mb-1 active d-flex align-items-center"><i class="bi bi-book-half" style="font-size: 20px"></i><span>Books</span></div>
        ...
        <div class="menu-container2 mb-4 mt-5">
          <div class="profile ps-3 ps-lg-3 mt-1 mb-1 d-flex align-items-center"><i class="bi bi-person-square" style="font-size: 20px"></i><span>Profile</span></div>
          ...
          <div class="row justify-content-center">
            <div class="col-md-8 col-lg-6">
              <div class="position-relative">
                ...
                <div
                  class="position-absolute top-50 end-0 translate-middle-y d-flex">
  ...
  <div class="modal fade" id="newModal" tabindex="-1" aria-labelledby="newModalLabel" aria-hidden="true">
    <div class="modal-dialog modal-dialog-centered">
      <div class="modal-content">
        ...
        <form action="database/insert.php" method="POST" class="modal-form" onsubmit="formHandler(event)">
  ...
  <div class="modal fade" id="deleteModal" tabindex="-1" data-bs-backdrop="static" aria-labelledby="deleteModalLabel"
    ...
    <div class="modal-dialog">
      <div class="modal-content">
        ...
        <div class="modal-footer">
          <button type="button" class="btn btn-secondary" data-bs-dismiss="modal">Close</button>
          <form action="database/delete.php" method="post" onsubmit="formHandler(event)">
  ...
  <div class="modal fade" id="updateModal" tabindex="-1" data-bs-backdrop="static" aria-labelledby="updateModalLabel"
    aria-hidden="true">
    <div class="modal-dialog">
      <form action="database/update.php" method="post" onsubmit="formHandler(event)" class="update-form">
        <div class="modal-content">
